...
export const initialCategories = [
  {
    ...
    name: "Huiles Moteur",
    slug: "huiles-moteur",
    image_url: "/uploads/categories/huiles-moteur.jpg",
    is_active: true,
    created_at: ts(90),
    updated_at: ts(5),
  },
  {
    ...
    image_url: "/uploads/categories/additifs.jpg",
    is_active: true,
    created_at: ts(90),
    updated_at: ts(5),
  },
  {
    ...
    image_url: "/uploads/categories/graisses.jpg",
    is_active: true,
    created_at: ts(90),
    updated_at: ts(5),
  },
...
export const initialProducts: Product[] = [
  {
    ...
    stock: 24,
    category_id: 1,
    image_url: "/uploads/products/total-quartz-9000.jpg",
    is_active: true,
    is_visible: true,
    viscosity: "5W-40",
  ...
  },
  {
    ...
    stock: 18,
    category_id: 1,
    image_url: "/uploads/products/castrol-edge.jpg",
    is_active: true,
    is_visible: true,
    viscosity: "5W-30",
    motor_type: "Essence",
  ...
  },
  {
    ...
    stock: 32,
    category_id: 1,
    image_url: "/uploads/products/elf-evolution.jpg",
    is_active: true,
    is_visible: true,
    viscosity: "10W-40",
    motor_type: "Essence / Diesel",
  ...
  },
  {
    ...
    stock: 12,
    category_id: 1,
    image_url: "/uploads/products/liqui-moly-diesel.jpg",
    is_active: true,
    is_visible: true,
    viscosity: "5W-40",
    motor_type: "Diesel",
  ...
  },
  {
    ...
    stock: 45,
    category_id: 2,
    image_url: "/uploads/products/wynns-injecteurs.jpg",
    is_active: true,
    is_visible: true,
    viscosity: "N/A",
    motor_type: "Diesel",
  ...
  },
  {
    ...
    stock: 20,
    category_id: 2,
    image_url: "/uploads/products/bardahl-anti-fuite.jpg",
    is_active: true,
    is_visible: true,
    viscosity: "N/A",
    motor_type: "Essence / Diesel",
  ...
  },
  {
    ...
    stock: 15,
    category_id: 3,
    image_url: "/uploads/products/motul-graisse.jpg",
    is_active: true,
    is_visible: true,
    viscosity: "N/A",
